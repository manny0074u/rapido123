...
<!-- Mirrored from crenoveative.com/envato/hangan/admin-resume-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Dec 2016 06:41:03 GMT -->
<head>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-item">
										...
										<div class="image">
											<img src="images/<?php echo $rw['picture'] ?>" alt="image" class="img-circle" />
										</div>
										
											<h4><?php echo $rw['firstname'] ?> <?php echo $rw['lastname'] ?></h4>
										<p class="user-role">Merchant</p>
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="add_account.php"><i class="fa fa-users"></i> Add Account</a>
										</li>
