...
<!-- Mirrored from crenoveative.com/envato/hangan/account-login-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Dec 2016 06:49:53 GMT -->
<head>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="index.php"><img src="images/rapido.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="request_atm.php">Request Atm</a>
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<div class="checkbox-block"> 
								<input id="remember_me_checkbox-2" name="remember_me_checkbox-2" class="checkbox" value="First Choice" type="checkbox"> 
								<label class="" for="remember_me_checkbox-2">Remember me</label>
							</div>
						</div>
